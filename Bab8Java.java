...
//        {
//            int jumlahKelas
//                    = Integer.parseInt(JOptionPane.showInputDialog(null,  "Masukan jumlah kelas : ",    "Input", JOptionPane.INFORMATION_MESSAGE));
//            String isiKelas[][] = new String[jumlahKelas][];
//            for (int kelas = 0; kelas < jumlahKelas; kelas++) {
//
//                String namaKelas = 
//                        JOptionPane.showInputDialog(null, "Nama Kelas:  ",  "  Masukan Nama Kelas",JOptionPane.INFORMATION_MESSAGE);
